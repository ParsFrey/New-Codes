...
"font: 16pt \"MS Shell Dlg 2\";")
        ...
        self.plainTextEdit.setGeometry(QtCore.QRect(33, 30, 371, 361))
    ...
    def press_it(self):
        ...
        #"البته اينکه يه چيز از قبل تعريف شده بهش بديم که اونو با دستور پرينت چاپ کنه اون مشکلي نداره"
    #def write_it(self):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.plainTextEdit.setPlainText(_translate("MainWindow", "write your code here."))
